...
A=imread('ailanthusaltissima_otc02.jpg');
...
for i=1:qq
    for j=1:pp
        ...
        if seg_I(i,j)==1 
              Greencluster1=[Greencluster1 AG(i,j)];
        end
        
        if seg_I(i,j)==2 
              Greencluster2=[Greencluster2 AG(i,j)];
        end
        
        if seg_I(i,j)==3 
              Greencluster3=[Greencluster3 AG(i,j)];
        end
    end
end
...
injury=size(Greencluster3,2)/(size(Greencluster2,2)+size(Greencluster3,2))*100
